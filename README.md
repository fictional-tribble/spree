...
| [spree_analytics_trackers](https://github.com/spree-contrib/spree_analytics_trackers) | [![Build Status](https://travis-ci.org/spree-contrib/spree_analytics_trackers.svg?branch=master)](https://travis-ci.org/spree-contrib/spree_analytics_trackers) [![GuardRails badge](https://badges.production.guardrails.io/fictional-tribble/spree.svg)](https://www.guardrails.io) | Adds support for Analytics Trackers (Google Analytics & Segment)
